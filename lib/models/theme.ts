...
export const CustomTheme =
  mongoose.models.CustomTheme ??
  mongoose.model<ICustomTheme>('CustomTheme', CustomThemeSchema)
export const ActiveTheme =
  mongoose.models.ActiveTheme ??
  mongoose.model<IActiveTheme>('ActiveTheme', ActiveThemeSchema)
