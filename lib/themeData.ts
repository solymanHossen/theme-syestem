...
export const themeCategories = [
  { id: 'all', name: 'All Themes', count: themes.length },
  {
    id: 'outdoor',
    name: 'Outdoor',
    count: themes.filter(t => t.category === 'outdoor').length,
  },
  {
    id: 'modern',
    name: 'Modern',
    count: themes.filter(t => t.category === 'modern').length,
  },
  {
    id: 'classic',
    name: 'Classic',
    count: themes.filter(t => t.category === 'classic').length,
  },
  {
    id: 'vibrant',
    name: 'Vibrant',
    count: themes.filter(t => t.category === 'vibrant').length,
  },
  {
    id: 'nature',
    name: 'Nature',
    count: themes.filter(t => t.category === 'nature').length,
  },
  {
    id: 'minimal',
    name: 'Minimal',
