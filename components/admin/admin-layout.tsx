...
export function AdminLayout({
  ...
  return (
    <div
      className="min-h-screen flex themed-background"
        ...
        >
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <div>
                <h2
                  className="font-semibold themed-text"
          ...
          >
            <div className="flex items-center justify-between">
              <span className="text-sm font-medium themed-text">
                Theme Mode
              </span>
              <ThemeToggle />
            </div>
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1
                className="text-xl font-semibold themed-text"
                style={{ color: currentTheme.palette.text }}
              >
