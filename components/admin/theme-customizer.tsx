...
export function ThemeCustomizer({
  ...
  const {
    setPreviewTheme,
    generateUniqueThemeId: _generateUniqueThemeId,
  ...
  const updateTypography = (
    category: keyof CustomTheme['typography'],
    key: string,
    value: string
  ) => {
    updateTheme({
  ...
  const updateComponents = (
    category: keyof CustomTheme['components'],
    key: string,
    value: any
  ) => {
    updateTheme({
  ...
  const currentModeData = customTheme[
    `${activeMode}Mode` as keyof CustomTheme
  ] as any
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Create and customize every aspect of your theme
          </p>
        </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={value =>
                      updateTheme({ category: value as any })
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1 space-y-2">
                        <Input
                          ...
                          onChange={e =>
                            updatePalette(activeMode, key, e.target.value)
                          }
        ...
        <TabsContent value="typography" className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={value =>
                      updateTypography('fontFamily', 'primary', value)
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={value =>
                      updateTypography('fontFamily', 'secondary', value)
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={value =>
                      updateTypography('fontFamily', 'mono', value)
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div
                          ...
                          style={{
                            fontSize: value,
                            fontFamily:
                              customTheme.typography.fontFamily.primary.split(
                                ','
                              )[0],
                          }}
                        >
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                {Object.entries(customTheme.typography.fontWeight).map(
                  ([key, value]) => (
                    <div key={key} className="space-y-2">
                      <Label className="capitalize">{key}</Label>
                      <div className="flex items-center gap-2">
                        <Input
                          ...
                          value={value}
                          onChange={e =>
                            updateTypography('fontWeight', key, e.target.value)
                          }
                          className="flex-1 font-mono text-sm"
                          placeholder="400"
                        />
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-4">
                  ...
                  {Object.entries(customTheme.typography.lineHeight).map(
                    ([key, value]) => (
                      <div key={key} className="space-y-2">
                        <Label className="capitalize">{key}</Label>
                        <Input
                          ...
                          value={value}
                          onChange={e =>
                            updateTypography('lineHeight', key, e.target.value)
                          }
                          className="font-mono text-sm"
                          placeholder="1.5"
                        />
                ...
                <div className="space-y-4">
                  ...
                  {Object.entries(customTheme.typography.letterSpacing).map(
                    ([key, value]) => (
                      <div key={key} className="space-y-2">
                        <Label className="capitalize">{key}</Label>
                        <Input
                  ...
                  <div key={key} className="space-y-3">
                    ...
                    <Select
                      ...
                      onValueChange={newValue =>
                        updateRadius(
                          key as keyof CustomTheme['radius'],
                          newValue as any
                        )
                      }
                    >
                    ...
                    <div className="p-4 border rounded-md bg-muted/50">
                      <div
                        ...
                        style={{
                          borderRadius:
                            radiusOptions.find(r => r.value === value)
                              ?.preview || '0px',
                        }}
                      >
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    value={customTheme.spacing.margin}
                    onValueChange={value => updateSpacing('margin', value)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                  ...
                  {Object.entries(customTheme.shadows).map(([key, value]) => (
                    <div key={key} className="space-y-3">
                      ...
                      <Input
                        ...
                        onChange={e =>
                          updateShadows(
                            key as keyof CustomTheme['shadows'],
                            e.target.value
                          )
                        }
                        className="font-mono text-sm"
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={value =>
                      updateComponents('button', 'size', value)
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={value =>
                      updateComponents('button', 'variant', value)
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                  ...
                  <div className="p-4 border rounded-md bg-muted/50 flex gap-2">
                    <button
                      ...
                      style={{
                        ...
                        borderRadius:
                          radiusOptions.find(
                            r => r.value === customTheme.radius.button
                          )?.preview || '6px',
                      }}
                    >
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={value =>
                      updateComponents('card', 'padding', value)
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={value =>
                      updateComponents('card', 'shadow', value)
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                ...
                <div className="space-y-2">
                  ...
                  <div
                    ...
                    style={{
                      ...
                      borderRadius:
                        radiusOptions.find(
                          r => r.value === customTheme.radius.card
                        )?.preview || '8px',
                      boxShadow:
                        customTheme.shadows[
                          customTheme.components.card
                            .shadow as keyof CustomTheme['shadows']
                        ],
                      padding:
                  ...
                  >
                    <h4
                      ...
                      style={{ color: currentModeData.palette.text }}
                    >
                      Sample Card
                    </h4>
                    <p
                      className="text-sm"
                      style={{ color: currentModeData.palette.muted }}
                    >
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={value =>
                      updateComponents('input', 'size', value)
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={value =>
                      updateComponents('input', 'variant', value)
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                  ...
                  <div className="p-4 border rounded-md bg-muted/50">
                    <input
                      ...
                      style={{
                        ...
                        borderRadius:
                          radiusOptions.find(
                            r => r.value === customTheme.radius.input
                          )?.preview || '6px',
                      }}
                    />
                  </div>
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <div
                    ...
                    style={{
                      ...
                      fontFamily:
                        customTheme.typography.fontFamily.primary.split(',')[0],
                    }}
                  >
                    <div>
                      <h3
                      ...
                      >
                        Experience the perfect blend of durability and comfort
                        with our premium outdoor tent.
                      </p>
                    </div>
                    ...
                    <div className="flex gap-4">
                      <button
                        ...
                        style={{
                          backgroundColor:
                            customTheme.lightMode.palette.primary,
                          borderRadius:
                            radiusOptions.find(
                              r => r.value === customTheme.radius.button
                            )?.preview || '6px',
                    ...
                    <div className="space-y-3">
                      <Label
                        style={{ color: customTheme.lightMode.palette.text }}
                      >
                        Email Address
                      </Label>
                      <input
                        ...
                        style={{
                          backgroundColor:
                            customTheme.lightMode.palette.background,
                          borderColor: customTheme.lightMode.palette.border,
                          color: customTheme.lightMode.palette.text,
                          borderRadius:
                            radiusOptions.find(
                ...
                <div>
                  ...
                  >
                    ...
                    <div className="space-y-3">
                      <Label
                        style={{ color: customTheme.darkMode.palette.text }}
                      >
                        Email Address
                      </Label>
                      <input
                        ...
                        style={{
                          backgroundColor:
                            customTheme.darkMode.palette.background,
                          borderColor: customTheme.darkMode.palette.border,
                          color: customTheme.darkMode.palette.text,
                          borderRadius:
                            radiusOptions.find(
                      ...
                      <div className="space-y-3">
                        {['xs', 'sm', 'md', 'lg', 'xl'].map(size => (
                          <input
                            ...
                            style={{
                              backgroundColor:
                                currentModeData.palette.background,
                              borderColor: currentModeData.palette.border,
                              color: currentModeData.palette.text,
                              borderRadius:
                                radiusOptions.find(
