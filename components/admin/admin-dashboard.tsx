...
export function AdminDashboard() {
  ...
  const recentActivity = [
    ...
    {
      action: "Product 'Alpine Tent' updated",
      time: '10 minutes ago',
      type: 'product',
    },
    {
      action: 'Theme switched to dark mode',
      time: '15 minutes ago',
      type: 'system',
    },
  ]
    ...
    <div className="space-y-6">
          ...
          return (
            <Card key={index} className="themed-card">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle
                  className="text-sm font-medium themed-text"
                  style={{ color: currentTheme.palette.muted }}
                >
                  {stat.title}
                </CardTitle>
              ...
              <CardContent>
                ...
                <p
                  className="text-xs"
                  style={{ color: currentTheme.palette.success }}
                >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="themed-card">
          <CardHeader>
            <CardTitle
              className="flex items-center gap-2 themed-text"
              style={{ color: currentTheme.palette.text }}
            >
      ...
      <Card className="themed-card">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <h4
                className="font-medium mb-2 themed-text"
                style={{ color: currentTheme.palette.text }}
              >
                Active Mode
              </h4>
